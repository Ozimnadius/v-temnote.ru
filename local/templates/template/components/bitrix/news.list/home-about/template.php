  ...
  <div class="home-about">
      ...
      <div class="home-about__swiper swiper">
        <div class="home-about__wrapper swiper-wrapper">
          <? foreach ($arResult["ITEMS"] as $arItem): ?>
            ...
            ?>
            <article class="home-about__slide swiper-slide"
    ...
    <? if (!empty($arParams["NOTICE_TEXT"])): ?>
      <div class="home-about__notice">
        <div class="home-about__notice-icon"
             aria-hidden="true"
        >
        ...
        <button type="button"
                class="home-about__button btn btn--outline"
        >
